...
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_dbms_quarantineDatabase[`dbms.quarantineDatabase()`] procedure is deprecated.
...
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_dbms_cluster_uncordonServer[`dbms.cluster.uncordonServer()`] procedure is deprecated.
...
RETURN 1 AS a
----
| The keyword `DISTINCT` can now be added after a xref:queries/combined-queries.adoc#union-distinct[UNION] as the explicit form of a `UNION` with duplicate removal.
...
a| These  link:{neo4j-docs-base-uri}/operations-manual/procedures//#_change_data_capture_cdc[CDC procedures] are deprecated.
|===
...
----
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_db_create_setvectorproperty[`db.create.setVectorProperty()`] and link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_db_index_vector_createnodeindex[`db.index.vector.createNodeIndex()`] procedures are deprecated.
...
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_dbms_upgrade[`dbms.upgrade()`] procedure is deprecated.
...
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_dbms_upgradestatus[`dbms.upgradeStatus()`] procedure is deprecated.
...
a| The link:{neo4j-docs-base-uri}/operations-manual/procedures/#procedure_dbms_cluster_readreplicatoggle[`dbms.cluster.readReplicaToggle()`] procedure is deprecated.
