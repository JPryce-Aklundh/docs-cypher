...
.`||` and `+`
// tag::expressions_string_concatenation_operators_basic[]
[source, cypher]
----
RETURN 'Neo' || '4j' AS result1,
       'Neo' + '4j' AS result2
----
// end::expressions_string_concatenation_operators_basic[]
...
.Concatenation using the `toString()` function
[source, cypher]
----
...
.Add whitespaces in string concatenation
// tag::expressions_string_concatenation_operators_whitespace[]
[source, cypher]
----
RETURN 'Alpha' || 'Beta' AS result1, 
       'Alpha' || ' ' || 'Beta' AS result2
----
// end::expressions_string_concatenation_operators_whitespace[]
...
// tag::expressions_string_concatenation_operators_properties[]
[source, cypher]
----
...
----
// end::expressions_string_concatenation_operators_properties[]
...
.Add separators in string concatenation
[source, cypher]
----
...
.Add prefix, suffix, and separators in string concatenation
// tag::expressions_string_concatenation_operators_prefix_suffix_separator[]
[source, cypher]
----
RETURN 'My favorite fruits are: ' || 'apples' || ', ' || 'bananas' || ', and ' || 'oranges' || '.' AS result
----
// end::expressions_string_concatenation_operators_prefix_suffix_separator[]
...
// tag::expressions_string_concatenation_operators_concatenate_strings_in_list[]
[source, cypher]
----
WITH ['Neo', '4j'] AS list
RETURN reduce(acc = '', item IN list| acc || item) AS result
----
// end::expressions_string_concatenation_operators_concatenate_strings_in_list[]
...
.Using `reduce()` and `coalesce()` to skip `NULL` values when concatenating `STRING` values in a `LIST`
// tag::expressions_string_concatenation_operators_skip_null[]
[source, cypher]
----
...
----
// end::expressions_string_concatenation_operators_skip_null[]
...
// tag::expressions_string_concatenation_operators_list_comprehension[]
[source, cypher]
----
WITH ['Apples', 'Bananas', 'Oranges'] AS list 
RETURN [item IN list | 'Eat more ' || item || '!'] AS result
----
// end::expressions_string_concatenation_operators_list_comprehension[]
